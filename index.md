...
The ML paper, as originally envisioned was a document printed and bound in journals: over time these documents were published online and underwent minor cosmetic changes, yet many assumptions of this original format survive, namely, that research must take the form of a static research paper. Yet modern ML research often contains multimedia and interactive applications which print-based document formats often do not support. To accommodate a more diverse content catalog requires authors and publishers to adopt a more inclusive format for sharing scientific research and rethink the role of conference publications to support the informational needs of authors and readers alike.

How much research is overlooked due to inaccessible communication? How many papers will still be accessible in ten or twenty years? How can we make the proceedings more inclusive and readable for future generations of ML researchers? These are some of the questions we plan to discuss in our workshop. Please join us for an exciting discussion on how to redesign the scientific paper for the next decade of machine learning research!
